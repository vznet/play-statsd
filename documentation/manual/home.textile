...
@$ play build-module # (you just hit enter at the prompt)@
...
@module.statsd=${play.path}/modules/statsd@
...
p(note). The module will log any errors, but will not cause the app to fail.